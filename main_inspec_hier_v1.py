...
config = {
    ...
    'vocab_size': 220428,
    'num_samples': 10000,
    'file_name' : 'decode-inspec-hier-v1',
...
if __name__ == '__main__':
    ...
    preprocessor_inspec.transform_sent_train_v1(config)
    preprocessor_inspec.transform_sent_valid_v1(config)
    preprocessor_inspec.transform_sent_test_v1(config)
   
    import decoder_inspec_hier_v1
    decoder_inspec_hier_v1.decoder(config)
