...
config = {
    ...
    'epoch': 100,
    'vocab_size': 10004,
    'file_name' : 'decode-krapivin-sts-fsoftmax-v1',
...
if __name__ == '__main__':
    ...
    preprocessor_krapivin.transform_v1_fsoftmax(config) 
        
    import decoder_krapivin_fsoftmax_v1
    decoder_krapivin_fsoftmax_v1.decoder(config)
