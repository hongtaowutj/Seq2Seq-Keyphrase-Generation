...
config = {
    ...
    'model_path':'models',
    'result_kp20k': 'results/kp20k/v1/hier-att-full',
    ...
    'epoch': 100,
    'vocab_size': 10004,
    'file_name' : 'decode-krapivin-hier-att-fsoftmax-v1',
...
if __name__ == '__main__':
    ...
    import decoder_krapivin_hier_att_fsoftmax_v1
    decoder_krapivin_hier_att_fsoftmax_v1.decoder(config)
