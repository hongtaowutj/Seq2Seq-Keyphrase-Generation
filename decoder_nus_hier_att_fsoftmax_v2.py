...
from models.hier_seq2seq_att_v2 import HierarchyAttFullSoftmax
...
def decoder(params):
	...
	outputs_conn = DataConnector(data_path, 'sent-output_tokens.npy', data=None)
	...
	X_in_connector = DataConnector(preprocessed_data, 'X_nus_pad_sent_fsoftmax.npy', data=None)
	X_in_connector.read_numpys()
	X_in = X_in_connector.read_file
