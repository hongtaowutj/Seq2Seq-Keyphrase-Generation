...
def evaluator(params):
    ...
    outputs_conn = DataConnector(data_path, y_true, data=None)
    ...
    all_rank_acc_conn = DataConnector(result_path, 'all_rank_acc', all_rank_acc)
    ...
    all_rank_recall_conn = DataConnector(result_path, 'all_rank_recall', all_rank_recall)
    all_rank_recall_conn.save_pickle()

    all_rank_fscore_conn = DataConnector(result_path, 'all_rank_fscore', all_rank_fscore)
    all_rank_fscore_conn.save_pickle()

    all_rank_tps_conn = DataConnector(result_path, 'all_rank_tps', all_rank_tps)
    all_rank_tps_conn.save_pickle()

    all_rank_fns_conn = DataConnector(result_path, 'all_rank_fns', all_rank_fns)
    all_rank_fns_conn.save_pickle()

    all_rank_fps_conn = DataConnector(result_path, 'all_rank_fps', all_rank_fps)
