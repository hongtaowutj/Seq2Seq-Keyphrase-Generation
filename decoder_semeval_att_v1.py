...
from models.seq2seq_att_sampled_softmax import AttentionSampledSoftmax
...
def decoder(params):
	...
	sampled_softmax = AttentionSampledSoftmax(encoder_length=encoder_length, decoder_length=decoder_length, embedding_dim=embedding_dim, birnn_dim=birnn_dim, rnn_dim=rnn_dim, vocab_size=vocab_size, num_samples=num_samples, filepath=result_kp20k, filename=file_name, batch_train_iter=None, batch_val_iter=None, batch_size=None, steps_epoch=None, val_steps=None, epochs=None)
	...
	beam_keyphrases = inference_mode.beam_decoder(X_in, y_dummy_test, s0_test, att0_test)
