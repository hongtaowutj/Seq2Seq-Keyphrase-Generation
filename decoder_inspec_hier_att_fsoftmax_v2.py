...
def decoder(params):
	...
	X_valid_connector = DataConnector(preprocessed_data, 'X_valid_pad_sent_fsoftmax.npy', data=None)
	...
	beam_keyphrases = inference_mode.beam_decoder(X_in[:500], s0_test[:500], att0_test[:500])
