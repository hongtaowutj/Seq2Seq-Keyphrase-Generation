...
config = {
    ...
    'epoch': 100,
    'vocab_size': 10004,
    'file_name' : 'decode-inspec-sts-fsoftmax-v1',
...
if __name__ == '__main__':
    ...
    preprocessor_inspec.transform_train_v1_fsoftmax(config)
    preprocessor_inspec.transform_valid_v1_fsoftmax(config)
    preprocessor_inspec.transform_test_v1_fsoftmax(config)
    
    
    import decoder_inspec_fsoftmax_v1
    decoder_inspec_fsoftmax_v1.decoder(config)
