...
config = {
    ...
    'epoch': 100,
    'vocab_size': 10004,
    'file_name' : 'sts-kp20k-fsoftmax-v1',
...
if __name__ == '__main__':
    ...
    preprocessor.transform_train_fsoftmax_v1(config)
    preprocessor.transform_valid_fsoftmax_v1(config)
    preprocessor.transform_test_fsoftmax_v1(config)
    ...
    import trainer_fsoftmax_v1
    trainer_fsoftmax_v1.trainer(config)

    

    import decoder_fsoftmax_v1
    decoder_fsoftmax_v1.decoder(config)
