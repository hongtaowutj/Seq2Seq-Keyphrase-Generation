...
def decoder(params):
	...
	'''
	indices_words_connector = DataConnector(preprocessed_v2, 'all_idxword_vocabulary.pkl', data=None)
	indices_words_connector.read_pickle()
	indices_words = indices_words_connector.read_file

	words_indices_connector = DataConnector(preprocessed_v2, 'all_wordidx_vocabulary.pkl', data=None)
	...
	X_train_connector = DataConnector(preprocessed_data, 'X_train_pad.npy', data=None)
	...
	sampled_softmax = SampledSoftmax(encoder_length=encoder_length, decoder_length=decoder_length, embedding_dim=embedding_dim, birnn_dim=birnn_dim, rnn_dim=rnn_dim, vocab_size=vocab_size, num_samples=num_samples, filepath=result_kp20k, filename=file_name, batch_train_iter=None, batch_val_iter=None, batch_size=None, steps_epoch=None, val_steps=None, epochs=None)
	...
	beam_keyphrases = inference_mode.beam_decoder(X_in, y_dummy_test)
