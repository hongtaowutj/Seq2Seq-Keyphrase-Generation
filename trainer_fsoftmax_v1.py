...
from models.seq2seq import FullSoftmax
...
def trainer(params):
	...
	full_softmax = FullSoftmax(encoder_length, decoder_length, embedding_dim, birnn_dim, rnn_dim, vocab_size,  result_path, file_name, batch_train_iter, batch_val_iter, batch_size, steps_epoch, val_steps, epoch)
	...
	t0 = time.time()
	print("Training model with full softmax...")
	sys.stdout.flush()
