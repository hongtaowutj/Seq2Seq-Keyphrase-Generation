...
config = {
    ...
    'epoch': 100,
    'vocab_size': 10004,
    'file_name' : 'decode-nus-hier-fsoftmax-v2',
...
if __name__ == '__main__':
    ...
    preprocessor_nus.transform_sent_v2_fsoftmax(config)

    import decoder_nus_hier_fsoftmax_v2
    decoder_nus_hier_fsoftmax_v2.decoder(config)
