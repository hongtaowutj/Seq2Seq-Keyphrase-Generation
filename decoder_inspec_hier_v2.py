...
def decoder(params):
	...
	test_out_connector = DataConnector(data_path, 'test_output_sent_tokens.npy', data=None)
	test_out_connector.read_numpys()
	test_out_tokens = test_out_connector.read_file

	y_test_true = np.concatenate((train_out_tokens, valid_out_tokens, test_out_tokens))
	...
	X_test_connector = DataConnector(data_path, 'X_test_pad_sent.npy', data=None)
