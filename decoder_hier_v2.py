...
def decoder(params):
	...
	X_pair_test_connector = DataConnector(preprocessed_data, 'x_pair_test_sent.npy', data=None)
	X_pair_test_connector.read_numpys()
	X_pair_test = X_pair_test_connector.read_file

	y_pair_test_in_connector = DataConnector(preprocessed_data, 'y_pair_test_in_sent.npy', data=None)
	y_pair_test_in_connector.read_numpys()
	y_pair_test_in = y_pair_test_in_connector.read_file

	y_pair_test_out_connector = DataConnector(preprocessed_data, 'y_pair_test_out_sent.npy', data=None)
