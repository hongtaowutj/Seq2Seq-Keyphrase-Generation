...
class HierarchyFullSoftmax():
	...
	def train_hier_seq2seq(self, pretrained_embedding, oov_embedding):
		...
		dec_outputs, dec_state_h = fwd_decoder(dec_embedded_sequences, initial_state=out_bidir_doc_encoder)
