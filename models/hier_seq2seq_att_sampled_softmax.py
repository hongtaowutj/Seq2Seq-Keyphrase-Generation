...
class HierarchyAttSampledSoftmax():
	...
	def train_hier_att_sampled_softmax(self):
	...
	def create_decoder_model(self):
		...
		# tensor/placeholder for decoder input (1 word) --> teacher forcing
		...
		decoder_states = [s]
		decoder_model = Model([in_decoder] + [doc_enc_out] + [in_state_decoder] + [in_label], [softmax_prob] + [alphas] + decoder_states)
