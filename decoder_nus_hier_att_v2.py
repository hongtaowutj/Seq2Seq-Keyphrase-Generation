...
from models.hier_seq2seq_att_sampled_softmax_v2 import HierarchyAttSampledSoftmax
...
def decoder(params):
	...
	X_in_connector = DataConnector(preprocessed_data, 'X_nus_pad_sent.npy', data=None)
	...
	sampled_softmax.train_hier_att_sampled_softmax(pretrained_embedding, oov_embedding)
