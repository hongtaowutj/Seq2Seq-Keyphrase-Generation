...
config = {
    ...
    'epoch': 100,
    'vocab_size': 10004,
    'file_name' : 'decode-inspec-hier-fsoftmax-v1',
...
if __name__ == '__main__':
    ...
    preprocessor_inspec.transform_sent_train_fsoftmax_v1(config)
    preprocessor_inspec.transform_sent_valid_fsoftmax_v1(config)
    preprocessor_inspec.transform_sent_test_fsoftmax_v1(config)

       
    import decoder_inspec_hier_fsoftmax_v1
    decoder_inspec_hier_fsoftmax_v1.decoder(config)
