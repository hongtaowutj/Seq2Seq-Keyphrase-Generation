...
if __name__ == '__main__':
    ...
    X_train = readPickle(os.path.join(DATA,'X_train_bigru.pkl'))
    X_valid = readPickle(os.path.join(DATA,'X_valid_bigru.pkl'))

    y_train_in = readPickle(os.path.join(DATA,'y_train_in_bigru.pkl'))
    y_train_out = readPickle(os.path.join(DATA,'y_train_out_bigru.pkl'))

    y_valid_in = readPickle(os.path.join(DATA,'y_valid_in_bigru.pkl'))
    y_valid_out = readPickle(os.path.join(DATA,'y_valid_out_bigru.pkl'))
    ...
    savePickle(all_x_train, os.path.join(DATA,'all_x_train'))
    savePickle(all_y_train_in, os.path.join(DATA,'all_y_train_in'))
    savePickle(all_y_train_out, os.path.join(DATA,'all_y_train_out'))
    ...
    savePickle(docid_pair_train, os.path.join(DATA,'docid_pair_train'))
    savePickle(x_pair_train, os.path.join(DATA,'x_pair_train'))
    savePickle(y_pair_train, os.path.join(DATA,'y_pair_train'))
    savePickle(y_pair_train_out, os.path.join(DATA,'y_pair_train_out'))
