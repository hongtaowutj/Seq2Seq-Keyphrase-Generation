...
if __name__ == '__main__':
	...
	for i, valid_data in enumerate(validation_data):
		...
		all_words_valid.extend(tokenizeWords(clean_title))
		all_words_valid.extend(tokenizeWords(clean_abstract))
		all_words_valid.extend(tokenizeWords(clean_keywords))
	...
	for i, test_data in enumerate(testing_data):
		...
		all_words_test.extend(tokenizeWords(clean_title))
		all_words_test.extend(tokenizeWords(clean_abstract))
		all_words_test.extend(tokenizeWords(clean_keywords))
	...
	savePickle(all_words_test, os.path.join(DATA,'all_words_test_wo'))
	#savePickle(tokenized_train_data, os.path.join(DATA,'tokenized_train_data'))
	#savePickle(tokenized_valid_data, os.path.join(DATA,'tokenized_valid_data'))
	savePickle(tokenized_test_data, os.path.join(DATA,'tokenized_test_data_wo'))
